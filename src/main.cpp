...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Surge: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Surge Signed Message:\n";
...
static const int64 nTargetTimespan = 60 * 200; // Surge: every 200 blocks
static const int64 nTargetSpacing = 60; // Surge: 60 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal surge miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Surge", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "27/03/2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395904931;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2368790;
        ...
        assert(block.hashMerkleRoot == uint256("0xbf731cb2332a6c23708214fd0a5625110e08a064ea95e6e2a9fca235d9834a13"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // surged: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
